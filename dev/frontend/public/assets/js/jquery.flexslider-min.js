		...
		$.data(t, 'flexslider', n),
			(f = {
				...
				pausePlay: {
					...
					update: function(e) {
						'play' === e
							? n.pausePlay.removeClass(i + 'pause').addClass(i + 'play').html(n.vars.playText)
							: n.pausePlay.removeClass(i + 'play').addClass(i + 'pause').html(n.vars.pauseText);
					}
				},
				touch: function() {
					function e(e) {
						...
						if (e) {
							...
							document.addEventListener(t, function() {
								f.pauseInvisible.isHidden()
									? n.startTimeout ? clearTimeout(n.startTimeout) : n.pause()
									: n.started
										? n.play()
					...
					if (
						...
						v
							...
							: (h =
									...
									n.vars.animationLoop &&
									'next' !== n.direction
										? u ? (n.count + n.cloneOffset) * c : 0
										: n.currentSlide === n.last &&
											0 === e &&
											n.vars.animationLoop &&
											'prev' !== n.direction
											? u ? 0 : (n.count + 1) * c
											: u ? (n.count - 1 - e + n.cloneOffset) * c : (e + n.cloneOffset) * c),
							...
							: e !== n.currentSlide || m
								? n.vars.animationLoop
									...
									: n.atEnd && 0 === n.currentSlide && e === a && 'next' !== n.direction
										? !1
										: n.atEnd && n.currentSlide === a && 0 === e && 'next' === n.direction ? !1 : !0
								: !1;
			}),
				...
				if (p)
					...
					'init' === e &&
						...
						n.vars.animationLoop &&
							...
							n.container
								.append(
									f.uniqueID(n.slides.first().clone().addClass('clone')).attr('aria-hidden', 'true')
								)
								.prepend(
						...
						? ((n.itemT = n.vars.itemWidth + t),
							...
							(n.itemW =
								n.minW > n.w
									...
									: n.maxW < n.w
										? (n.w - t * (i - 1)) / i
										: n.vars.itemWidth > n.w ? n.w : n.vars.itemWidth),
			...
			(n.addSlide = function(e, t) {
				...
				(n.count += 1),
					(n.last = n.count - 1),
					d && u
						? void 0 !== t ? n.slides.eq(n.count - t).after(a) : n.container.prepend(a)
						: void 0 !== t ? n.slides.eq(t).before(a) : n.container.append(a),
					n.update(t, 'add'),
			...
			(n.removeSlide = function(e) {
				...
				(n.count -= 1),
					...
					isNaN(e)
						? $(e, n.slides).remove()
						: d && u ? n.slides.eq(n.last).remove() : n.slides.eq(e).remove(),
					n.doMath(),
					n.update(t, 'remove'),
					(n.slides = $(n.vars.selector + ':not(.clone)', n)),
					n.setup(),
